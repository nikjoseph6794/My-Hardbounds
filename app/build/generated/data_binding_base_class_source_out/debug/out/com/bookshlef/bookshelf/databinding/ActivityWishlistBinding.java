...
public final class ActivityWishlistBinding implements ViewBinding {
  ...
  private ActivityWishlistBinding(@NonNull LinearLayout rootView, @NonNull TextView header,
      @NonNull RecyclerView wishlistList) {
  ...
  public static ActivityWishlistBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.wishlistList;
      RecyclerView wishlistList = ViewBindings.findChildViewById(rootView, id);
      if (wishlistList == null) {
        break missingId;
      }

      return new ActivityWishlistBinding((LinearLayout) rootView, header, wishlistList);
    }
